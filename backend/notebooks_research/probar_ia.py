...
datos_dict = {
    ...
    'services_lag_7': [110],   # Observed value from one week ago
    'avg_4_weeks': [105.5],
    'capacity_limit': [150],
    'table_count': [40],
...
try:
    ...
    print("\n" + "="*40)
    print(f" FINAL RESULT: {int(prediccion[0])} personas/servicios")
    print("="*40)
