...
def load_datos_ratings():
    ...
    try:
        ...
        conn.commit()
        print(f"�o. ¡�?xito! Ratings actualizados correctamente.")

    except Exception as e:
        print(f"�O Error during process: {e}")
        conn.rollback()
    finally:
        conn.close()
