...
export default function PredictionDashboard() {
  ...
  const [menuPredictions, setMenuPredictions] =
    useState<MenuPredictionState>(emptyPredictions);
  const [predictionLoading, setPredictionLoading] = useState(false);
  const [predictionError, setPredictionError] = useState("");
  const [servicePrediction, setServicePrediction] = useState<number | null>(
    null,
  );
      ...
      try {
        ...
        setError(
          err instanceof Error
            ? err.message
            : "No se pudo cargar tu restaurante.",
        );
      } finally {
        setLoading(false);
      }
  ...
  useEffect(() => {
    ...
    const loadPredictions = async () => {
      try {
        ...
        const [serviceData, starterData, mainData, dessertData] =
          (await Promise.all([
            serviceRes.json(),
            starterRes.json(),
            mainRes.json(),
        ...
        const message =
          err instanceof Error
            ? err.message
            : "No se pudieron obtener las predicciones.";
    ...
    return (
      <div className="rounded-2xl border border-[var(--border)] bg-[var(--surface-soft)]/40 p-12 text-center">
        <div className="inline-flex items-center gap-3">
          <svg
            className="w-5 h-5 animate-spin text-[#E07B54]"
    ...
    <section className="space-y-8">
      ...
      <div className="space-y-3">
        ...
        <p className="text-base text-[var(--text-muted)]">
          Descubre qué platos funcionarán mejor según el día, clima y
          características de tu restaurante.
        </p>
      </div>
      ...
      <div className="rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-8 shadow-lg">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
          ...
          <div className="space-y-2">
            <label className="block text-sm font-semibold text-[var(--text-muted)] uppercase tracking-wide">
              Seleccionar fecha
            </label>
            <input
              type="date"
      ...
      {checkingTodayMenu || predictionLoading ? (
        ...
        <div className="rounded-2xl border-2 border-[#FF9800] bg-[var(--surface)]/50 p-8 text-center">
          ...
          <p className="text-sm font-semibold text-[#FF9800]">
            Menú del día ya publicado
          </p>
          <p className="text-xs text-[var(--text-muted)] mt-3">
            Las predicciones de IA aparecen para días futuros. Selecciona una
            fecha próxima para ver sugerencias.
          </p>
        </div>
      ) : predictionError ? (
        <div className="rounded-2xl border-2 border-[#E53935] bg-[var(--surface)] p-8">
          <div className="flex gap-4">
            ...
            <div>
              <p className="text-sm font-semibold text-[#E53935]">
                Error al calcular predicciones
              </p>
        ...
        <div className="space-y-8">
            ...
            <>
              <div className="rounded-2xl border-2 border-[#E07B54] bg-gradient-to-br from-[#E07B54]/10 to-[#E07B54]/5 p-8 shadow-lg">
                <div className="flex items-end justify-between gap-6">
                  <div className="space-y-2">
                    <p className="text-sm font-bold text-[#E07B54] uppercase tracking-widest">
                      Demanda estimada
                    </p>
                    <p className="text-[#E07B54]">
                      para el{" "}
                  ...
                  <div className="text-right">
                    <p className="text-5xl font-black text-[#E07B54]">
                      {servicePrediction}
                    </p>
                    <p className="text-sm text-[#E07B54]/80 font-semibold mt-1">
                      servicios
                    </p>
                  </div>
                </div>
            ...
            <div className="bg-gradient-to-r from-[#E07B54]/15 to-[#E07B54]/5 border-b border-[var(--border)] px-8 py-6">
              <div className="flex items-center gap-3 mb-2">
                ...
                <div>
                  ...
                  <h3 className="text-xl font-bold text-[var(--text)] mt-0.5">
                    Recomendación de IA
                  </h3>
                </div>
              </div>
            ...
            <div className="px-8 py-8 space-y-6">
              ...
              <div className="bg-[var(--surface-soft)]/40 rounded-2xl border border-[var(--border)] p-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <p className="text-xs font-bold text-[#E07B54] uppercase tracking-widest">
                      Entrada
                    </p>
                    <p className="text-sm text-[var(--text-muted)]">
                      Para comenzar
                ...
                <ul className="space-y-2 pl-10">
                  {menuPredictions.starters.length > 0 ? (
                    menuPredictions.starters.map((dish, idx) => (
                      <li
                        key={idx}
                        className="text-sm font-medium text-[var(--text)] flex items-center gap-3 before:content-[''] before:w-2 before:h-2 before:rounded-full before:bg-[#E07B54]/60"
                      >
                        {dish.name}
                      </li>
                    ))
              ...
              <div className="flex items-end justify-between">
                <div>
                  ...
                  <p className="text-sm text-[var(--text)] mt-1">
                    Menú completo por persona
                  </p>
                </div>
                <div className="text-right">
                  <p className="text-3xl font-black text-[#E07B54]">
                    EUR {(restaurant?.menu_price ?? 20).toFixed(2)}
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-bold text-[var(--text)] flex items-center gap-2">
              <span>?</span> ¿Qué te parece esta predicción de menu?
            </h3>
              ...
              <div className="space-y-3">
                ...
                <ul className="space-y-2 text-sm text-[var(--text-muted)]">
                  <li className="flex gap-3">
                    <span className="text-[#E07B54] font-bold flex-shrink-0">
                      &gt;
                    </span>
                    <span>
                      Las predicciones se generan basándose en características
                      de tu restaurante, clima local y patrones históricos
                    </span>
                  </li>
                  <li className="flex gap-3">
                    <span className="text-[#E07B54] font-bold flex-shrink-0">
                    ...
                    <span>
                      Selecciona fechas futuras para ver estimaciones de demanda
                      durante la semana
                    </span>
                  </li>
                  <li className="flex gap-3">
                    ...
                    <span>
                      Usa estas recomendaciones para optimizar tu oferta y
