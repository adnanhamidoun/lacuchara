...
export default function AIDisclaimer({
  ...
  const defaultMessages = {
    warning:
      "Las predicciones de IA pueden tener errores. Úsalas como punto de partida, no como base única para decisiones críticas.",
    info: "Estas predicciones se generan automáticamente usando inteligencia artificial. No son garantías, sino recomendaciones.",
    error:
      "Hubo un problema al generar las predicciones. Por favor, intenta de nuevo más tarde.",
  };

  return (
    <div
      className={`rounded-xl border ${style.border} ${style.bg} p-4 flex gap-3 items-start`}
    >
