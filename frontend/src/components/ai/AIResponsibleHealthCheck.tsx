...
export default function AIResponsibleHealthCheck({
  ...
  const checks: AIResponsibleHealthCheckResult[] = [
    ...
    },
    {
      ...
      status: "ok",
      message: "�sltimo reentrenamiento: hace 5 días",
    },
    {
    ...
    },
    {
      ...
      status: "ok",
      message: "�sltimo: hace 30 días | Resultado: <3% disparidad",
    },
  ];
  ...
  return (
    <div className="rounded-xl border border-[var(--border)] bg-[var(--surface)] p-6 space-y-6">
      ...
      <div className="space-y-2">
        ...
        <div className="flex gap-4 text-sm">
          ...
          <div className="flex items-center gap-2">
            ...
            ></span>
            <span className="text-[var(--text-muted)]">
              {statusCounts.warning} Advertencias
            </span>
          </div>
          <div className="flex items-center gap-2">
            <span
      ...
      <div className="text-xs text-[var(--text-muted)] pt-4 border-t border-[var(--border)]">
        <p>
          �Y"� Este check verifica que todos los componentes de IA Responsable
          estén funcionando. Se ejecuta automáticamente cada hora.
        </p>
        <p className="mt-1">
          �sltimo check: hace 12 minutos | Próximo: en 48 minutos
        </p>
      </div>
    </div>
  );
