  ...
  return (
    <div className="space-y-6 rounded-xl border border-[var(--border)] bg-[var(--surface)] p-6">
      ...
      <div className="space-y-3">
        ...
        <div className="space-y-2">
          {factors.map((factor, idx) => (
            <div
              key={idx}
              className="p-4 rounded-lg bg-[var(--surface-soft)]/50 border border-[var(--border)]/50"
            >
              {/* Header del factor */}
      ...
      <div className="pt-4 border-t border-[var(--border)] text-xs text-[var(--text-muted)] space-y-1">
        <p>
          💡 La confianza se calcula considerando: cantidad de datos históricos,
          consistencia del patrón, variabilidad de factores externos y desempeño
          histórico.
        </p>
        <p>
          �Y"S �sltima actualización: Hace 6 horas | Próxima revisión: En 24
          horas
        </p>
      </div>
    </div>
